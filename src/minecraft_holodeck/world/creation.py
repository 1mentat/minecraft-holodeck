...
def create_flat_world(
    ...
    *,
    ...
    try:
        ...
        # Set game rules and world settings for a better flat world experience
        ...
        # Set spawn point at center of world
        ...
        # Save and close the empty world first
        world_wrapper.save()
        world_wrapper.close()
...
def create_void_world(
    ...
    *,
    ...
    try:
        ...
        # Set game rules for void world
        world_wrapper.root_tag["Data"]["GameType"] = TAG_Int(1)  # Creative mode
        world_wrapper.root_tag["Data"]["Difficulty"] = TAG_Byte(2)
        world_wrapper.root_tag["Data"]["hardcore"] = TAG_Byte(0)
        world_wrapper.root_tag["Data"]["MapFeatures"] = TAG_Byte(0)
        world_wrapper.root_tag["Data"]["raining"] = TAG_Byte(0)
        world_wrapper.root_tag["Data"]["thundering"] = TAG_Byte(0)
        world_wrapper.root_tag["Data"]["Time"] = TAG_Long(6000)
